...
VARIANTS=[
 ...
 ("CHOP55",{"chop":55}),
 ("CHOP50",{"chop":50}),
 ("EMA50_SLOPE",{"ema_slope":True}),
 ("ADX20_ER30",{"adx":20,"er":.30}),
 ("ADX20_CHOP55",{"adx":20,"chop":55}),
]
...
def main():
 ...
 summary.to_csv(OUT/"pc_base15_entry_filter_sweep_summary.csv",index=False)
 pd.concat(trades,ignore_index=True).to_csv(OUT/"pc_base15_entry_filter_sweep_trades.csv",index=False)
